...
class TestPlaywrightShowcase:
    ...
    def test_05_frame_a_click_action(self):
        ...
        expect(
            self.app.frame_alpha().locator("#res-A")
        ).to_have_text("Iframe A Clicked!")
    ...
    def test_07_frame_b_click_action(self):
        ...
        expect(
            self.app.frame_beta().locator("#res-B")
        ).to_have_text("Iframe B Clicked!")
    ...
    def test_09_frame_c_click_action(self):
        ...
        self.app.frame_gamma().get_by_role(
            "button",
            name="Click button"
        ).click()

        expect(
            self.app.frame_gamma().locator("#res-C")
        ).to_have_text("Iframe C Clicked!")
    ...
    def test_10_open_new_tab(self):
        with self.page.expect_popup() as popup_info:
            self.page.get_by_role(
                "button",
                name="Open New Tab (playwright.dev)"
            ).click()
        ...
        expect(popup).to_have_url(
            re.compile(r"https://playwright\.dev/?")
        )
    ...
    def test_14_modal_confirm_action(self):
        ...
        expect(
            self.page.locator("#modal-result")
        ).to_contain_text("✓ Verified: CODE1")
    ...
    def test_20_confirm_cancel(self):
        ...
        expect(
            self.page.locator("#confirm-result")
    ...
    def test_23_prompt_cancel(self):
        ...
        expect(
            self.page.locator("#prompt-result")
    ...
    def test_25_form_empty_both(self):
        ...
        expect(
            self.page.locator("#trace-result")
        ).to_contain_text("Both fields are required")
    ...
    def test_31_element_screenshot_failure(self):
        ...
        # CỐ TÌNH FAILED
        expect(
            self.page.locator("#vr-full-display")
        ).to_have_text("System Normal")
    ...
    def test_34_video_flow_fail(self):
        ...
        # CỐ TÌNH FAILED
        expect(
            self.page.locator("#vr-action-txt")
        ).to_contain_text(
    ...
    def test_37_tracing_invalid_ng(self):
        ...
        expect(
            self.page.locator("#trace-result")
        ).to_contain_text("✓ Submitted successfully")
    ...
    def test_38_before_all_check(self):
        ...
        print(
            "[beforeAll] Setup môi trường test. Artifacts sẽ được lưu tại bảng Records"
        )
    ...
    def test_39_after_all_cleanup(self):
        ...
        for name, category, category_label in record_cases:
            self.app.hooks_create_record_and_verify(
                name,
                category,
                category_label
            )
        ...
        expect(
            self.page.locator("#hk-logout-msg")
        ).to_contain_text("afterAll")
    ...
    def test_40_before_each_hooks(self):
        expect(
            self.page.locator("#hk-main-section")
        ).to_be_visible()

        expect(
            self.page.locator("#hk-logged-user")
        ).to_have_text("admin")

        self.app.hooks_create_record(
            "Hook record",
            "bug"
        )
